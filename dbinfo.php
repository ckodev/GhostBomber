...
// const DB_USER		= "ghost";	// <-- add your MySQL userame here
// const DB_PASS		= "bcit";	// <-- add your MySQL password here
// const DB_NAME		= "ghostbomber";

// const DB_HOST		= "localhost";			
// const DB_USER		= "coryowen_ghost";	// <-- add your MySQL userame here
// const DB_PASS		= "b9Xeba\$Z-zXf";	// <-- add your MySQL password here
// const DB_NAME		= "coryowen_ghostBomber";
